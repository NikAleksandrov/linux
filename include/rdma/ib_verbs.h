...
struct ib_device_ops {
	...
	int (*fill_res_pd_entry)(struct sk_buff *msg, struct ib_pd *ibpd);
 ...
 * accessor closes the gap so driver-side dump-side verbs (e.g.
 * mlx5_ib's `MLX5_IB_METHOD_VFMIG_QUERY_QP`) can read user_handle
