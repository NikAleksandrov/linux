...
`tools/testing/criu_rdma/uobject_restore/qp_av_dmac/check_qp_av_dmac.sh`,
...
The harness `tools/testing/criu_rdma/uobject_restore/qp_av_dmac/check_qp_av_dmac.sh`
...
`tools/testing/criu_rdma/qp_av_dmac_capture.sh`:
...
>   `tools/testing/criu_rdma/tools/mlx5_vfmig.c`
> * `tools/testing/criu_rdma/uobject_restore/qp_av_dmac/refresh_av_dmac.sh`
>   wrapper script
>
...
| `tools/testing/criu_rdma/tools/mlx5_vfmig.c` | new `do_refresh_av_dmac()` verb-handler with key=value output (including a derived `verdict=` line) and updated usage. | ~110 |
| `tools/testing/criu_rdma/uobject_restore/qp_av_dmac/refresh_av_dmac.sh` | new wrapper mirroring `check_qp_av_dmac.sh`'s PF/VF derivation; drives the ioctl and decodes the verdict. | ~140 |
...
```sh
sudo PF=$PF_BDF tools/testing/criu_rdma/uobject_restore/qp_av_dmac/\
...
- 2026-06-04 (later evening): first end-to-end run with KS6b.1 in
  ...
  core/vfmig/vfmig.c` (~230 LOC handler), `tools/testing/criu_rdma/
  tools/mlx5_vfmig.c` (`refresh_av_dmac` verb), and
  `tools/testing/criu_rdma/uobject_restore/qp_av_dmac/
