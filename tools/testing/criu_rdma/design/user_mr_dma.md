...
>   running kernel via
>   `tools/testing/criu_rdma/save_load/user_object_replay/test_user_object_replay.sh`
...
* `tools/testing/criu_rdma/save_load/user_object_replay/` --
  stage-2 empirical harness (probe + shell script).
* `tools/testing/criu_rdma/design/uar_restore.md` -- the verb-pattern
  template stages 2+3 follow.
* `tools/testing/criu_rdma/design/uobject_restore.md` -- §9.1 (S4b
